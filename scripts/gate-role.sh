...
case "$role" in
  memory)
    ...
    extra="amend recall remember forget why scroll layout applied overflowed jobs job_done notes note_open changes undo approve reject used outcome model resume" ;;
  tools)
    core="tools run"
